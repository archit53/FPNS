...
void initAWS()
{
  ...
  iotClient.setAWSDomain("a35ncatj6ix29q-ats.iot.us-east-1.amazonaws.com");   
  iotClient.setAWSPath("/things/iottestdevice/shadow");
  iotClient.setAWSKeyID("AKIAY2DV45HYOBP4N6VA");
  iotClient.setAWSSecretKey("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");
